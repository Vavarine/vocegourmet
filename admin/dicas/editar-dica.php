   ...
   <div class="content">
      ...
      <center>
         <div class="container">
            ...
            <form class="adicionar" method="POST" enctype="multipart/form-data" action="auterar-dica.php?id=<?php echo$id ?>">
               ...
               <textarea name="ingredientes" placeholder="Ingredientes ( separe os ingredientes com ';' )" id="titulo" required><?php echo$texto ?></textarea>
