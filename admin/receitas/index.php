...
<html>
	...
	<body class="loggedin preload">
		...
		<div class="content">
         ...
         <center>
            <div class="container">
               <a class="btn" href="add-receita.php"><div class="btn-grande">ADICIONAR RECEITA</div></a>


               <br><br>
               <h1 class="titulo">Receitas já adicionadas</h1>
               <hr>
               ...
               ?>
                  ...
                  <div class="receita">
                     ...
                     <div class="botoes">
                        <a href="excluir-receita.php?id=<?php echo$id ?>"><div class="excluir"><i class="far fa-trash-alt"></i></div></a>
                        <a href="editar-receita.php?id=<?php echo$id ?>"><div class="editar"><i class="far fa-edit"></i></div></a>
                     </div>
