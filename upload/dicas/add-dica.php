...
<head>
   ...
   <title>Adicionar Dica - Admin</title>
...
<body class="loggedin preload">
   ...
   <div class="content">
      <h2>Adicionar Dica</h2>
      <p>Adminsistrador logado: <?= $_SESSION['nome'] ?></p>

      <center>
         <div class="container">

            <form class="adicionar" method="POST" enctype="multipart/form-data" action="enviar-dica.php">
               ...
               <textarea name="texto" placeholder="Texto" oninput='if(this.scrollHeight > this.offsetHeight) this.rows += 1'></textarea>
